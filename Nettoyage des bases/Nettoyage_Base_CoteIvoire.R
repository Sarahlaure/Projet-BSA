...
data <- read_delim("E:/ISEP 2/MON DOSSIER/APPRENTISSAGE DES VACANCES/ISEP3/Projet BSA/BASES DE DONNEES INITIALES/Cote_ivoire.csv",
...
filtered_data_CI <- filtered_data_CI %>% drop_na(a_partir_de_POINT)
...
missing_values <- sapply(filtered_data_CI, function(x) sum(is.na(x)))
...
# Enregistrer 
write_xlsx(filtered_data_CI, "E:/ISEP 2/MON DOSSIER/APPRENTISSAGE DES VACANCES/ISEP3/Projet BSA/BASES DE DONNEES CORRIGEES/Base_CoteIvoire_Nettoyee.xlsx")

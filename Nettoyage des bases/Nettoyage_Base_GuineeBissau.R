...
data <- read_delim("E:/ISEP 2/MON DOSSIER/APPRENTISSAGE DES VACANCES/ISEP3/Projet BSA/BASES DE DONNEES INITIALES/Guinne_Bissau.csv",
...
filtered_data_GB <- filtered_data_GB %>% drop_na(a_partir_de_POINT)
...
missing_values <- sapply(filtered_data_GB, function(x) sum(is.na(x)))
...
# Enregistrer 
write_xlsx(filtered_data_GB, "E:/ISEP 2/MON DOSSIER/APPRENTISSAGE DES VACANCES/ISEP3/Projet BSA/BASES DE DONNEES CORRIGEES/Base_GuineeBissau_Nettoyee.xlsx")

...
data <- read_delim("E:/ISEP 2/MON DOSSIER/APPRENTISSAGE DES VACANCES/ISEP3/Projet BSA/BASES DE DONNEES INITIALES/Togo.csv",
...
filtered_data_Togo <- filtered_data_Togo %>% drop_na(a_partir_de_POINT)
...
missing_values <- sapply(filtered_data_Togo, function(x) sum(is.na(x)))
...
# Enregistrer 
write_xlsx(filtered_data_Togo, "E:/ISEP 2/MON DOSSIER/APPRENTISSAGE DES VACANCES/ISEP3/Projet BSA/BASES DE DONNEES CORRIGEES/Base_Togo_Nettoyee.xlsx")

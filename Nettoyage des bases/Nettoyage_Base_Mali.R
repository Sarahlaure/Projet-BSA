...
data <- read_delim("E:/ISEP 2/MON DOSSIER/APPRENTISSAGE DES VACANCES/ISEP3/Projet BSA/BASES DE DONNEES INITIALES/Mali.csv",
...
filtered_data_Mali <- filtered_data_Mali %>% drop_na(a_partir_de_POINT)
...
missing_values <- sapply(filtered_data_Mali, function(x) sum(is.na(x)))
...
# Enregistrer 
write_xlsx(filtered_data_Mali, "E:/ISEP 2/MON DOSSIER/APPRENTISSAGE DES VACANCES/ISEP3/Projet BSA/BASES DE DONNEES CORRIGEES/Base_Mali_Nettoyee.xlsx")
